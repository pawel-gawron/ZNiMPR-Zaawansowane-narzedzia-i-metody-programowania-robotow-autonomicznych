...
options = {
  ...
  num_point_clouds = 0,
  lookup_transform_timeout_sec = .05,  -- ?
  submap_publish_period_sec = 0.0001,  -- ?
  pose_publish_period_sec = 5e-10,  -- ?
  trajectory_publish_period_sec = 30e-10,  -- ?
...
-- TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.min_num_points = ?
